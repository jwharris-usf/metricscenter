        ...
        <div className="mx-auto px-4 sm:px-12 xl:max-w-6xl xl:px-0">
          ...
          <div className="flex items-center hover:bg-slate-200">
            <div className="flex flex-col p-4">
              <div className="flex flex-row grow font-semibold">
                MHSP GPRA FAQ
                <GrDocumentPdf size={20} className="ml-3"/>
                <Badge variant="success">Updated 7/15/25</Badge>
              </div>
              <div className="text-sm text-gray-500 mt-1">Commonly Asked Questions - MHSP Government Performance and Results Act (GPRA)</div>
            </div>
            <div className="flex items-center justify-end grow">
              <a className="m-4" href="/images/METRICS_MHSP_GPRA_FAQ_071525.pdf" target="_blank">
                <Button variant="ghost">
                  View <RxOpenInNewWindow size={18} className="ml-2"/>
                </Button>
              </a>
              <a className="m-4" href="/images/METRICS_MHSP_GPRA_FAQ_071525.pdf" download target="_blank">
                <Button variant="ghost">
                  Download <RxDownload size={18} className="ml-2"/>
                </Button>
              </a>
          ...
          <div className="flex items-center bg-gray-100/75 hover:bg-slate-200">
            <div className="flex flex-col p-4">
              ...
              <div className="text-sm text-gray-500 mt-1">Commonly Asked Questions - SBMH Government Performance and Results Act (GPRA)</div>
            </div>
            <div className="flex items-center justify-end grow">
              <a className="m-4" href="/images/METRICS_SBMH_GPRA_FAQ_071525.pdf" target="_blank">
                <Button variant="ghost">
                  View <RxOpenInNewWindow size={18} className="ml-2"/>
                </Button>
              </a>
              <a className="m-4" href="/images/METRICS_SBMH_GPRA_FAQ_071525.pdf" download target="_blank">
                <Button variant="ghost">
                  Download <RxDownload size={18} className="ml-2"/>
                </Button>
              </a>
          ...
          <div className="flex items-center hover:bg-slate-200">
            <div className="flex flex-col p-4">
              <div className="flex flex-row grow font-semibold">
                ...
                <GrDocumentPdf size={20} className="ml-3"/>
                <Badge variant="success">Updated 4/10/25</Badge>
              </div>
              <div className="text-sm text-gray-500 mt-1">This resource includes guidance for grantees completing Section A of the...</div>
            </div>
            <div className="flex items-center justify-end grow">
              <a className="m-4" href="/images/SBMH-GPRA-Guidance-Year-2-APR-4_10_25.pdf" target="_blank">
                <Button variant="ghost">
                  View <RxOpenInNewWindow size={18} className="ml-2"/>
                </Button>
              </a>
              <a className="m-4" href="/images/SBMH-GPRA-Guidance-Year-2-APR-4_10_25.pdf" download target="_blank">
                <Button variant="ghost">
                  Download <RxDownload size={18} className="ml-2"/>
                </Button>
              </a>
          ...
          <div className="flex items-center hover:bg-slate-200">
            ...
            <div className="flex items-center justify-end grow">
              <a className="m-4" href="/images/MHSP-GPRA-Guidance-Year-2-APR-4_10_25.pdf" target="_blank">
                <Button variant="ghost">
                  View <RxOpenInNewWindow size={18} className="ml-2"/>
                </Button>
              </a>
              <a className="m-4" href="/images/MHSP-GPRA-Guidance-Year-2-APR-4_10_25.pdf" download target="_blank">
                <Button variant="ghost">
                  Download <RxDownload size={18} className="ml-2"/>
                </Button>
              </a>
          ...
          <div className="flex items-center hover:bg-slate-200">
            ...
            <div className="flex items-center justify-end grow">
              <a className="m-4" href="/images/K-12-Suicide-Prevention-Practice-Brief-4.pdf" target="_blank">
                <Button variant="ghost">
                  View <RxOpenInNewWindow size={18} className="ml-2"/>
                </Button>
              </a>
              <a className="m-4" href="/images/K-12-Suicide-Prevention-Practice-Brief-4.pdf" download target="_blank">
                <Button variant="ghost">
                  Download <RxDownload size={18} className="ml-2"/>
                </Button>
              </a>
