...
{/*                <a href="https://youtu.be/yO2MT3-kLYY?si=loWtxkfewlpmbdC4" target="_blank" onClick={() => sendGAEvent('event', 'linkClicked', { value: 'Reimagining MTSS: A Pathway to Whole School Well-Being' })}>*/}
                <a href="https://youtu.be/yO2MT3-kLYY?si=loWtxkfewlpmbdC4" target="_blank" onClick={() => sendGAEvent('event', 'thumbnail_Reimagining MTSS: A Pathway to Whole School Well-Being' )}>
              ...
              <div className="pl-4 pt-2 pb-6 flex flex-col lg:items-center lg:flex-row">
                <div>
                  <p className="pl-4 font-bold">
                    <a className="flex pb-2" href="https://education.ucsb.edu/people/dean-emeriti-faculty/michael-furlong" target="_blank" onClick={() => sendGAEvent('event', 'link_Reimagining MTSS: Michael Furlong' )}>Michael Furlong <RxOpenInNewWindow size={18} className="ml-1 relative top-[2px]"/></a>
                    <a className="flex" href="https://education.ucsb.edu/research-faculty/bio?first=Erin&last=Dowdy" target="_blank" onClick={() => sendGAEvent('event', 'link_Reimagining MTSS: Erin Dowdy' )}>Erin Dowdy <RxOpenInNewWindow size={18} className="ml-1 relative top-[2px]"/></a>
                  </p>
                </div>
      ...
      */}
                  <a href="https://youtu.be/yO2MT3-kLYY?si=loWtxkfewlpmbdC4" target="_blank" onClick={() => sendGAEvent('event', 'button_Reimagining MTSS: A Pathway to Whole School Well-Being' )}>
                    <Button>
                      Watch video
